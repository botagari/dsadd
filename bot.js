...
client.on('message', async message => {
    ...
    if(message.author.bot) return;
    if(coolDown.has(message.author.id)) return message.channel.send(`**:stopwatch: | ${message.author.username}, your daily :yen: credits refreshes in \`\`1 minutes\`\`.**`);
                  ...
                  ctx.drawImage(ground, 0, 0, 400, 200);
                      ...
                      jimp.read(url, (err, ava) => {
                          ...
                          ava.getBuffer(jimp.MIME_PNG, (err, buf) => {
                              ...
                              ctx.fontSize = '20px';
                              ctx.fillStyle = "#f1f1f1";
      ctx.fillText(`Welcome To Server Knights Of Darkness`, 260, 125);
